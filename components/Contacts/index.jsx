            ...
            <div className={styles.wrapper_container_contacts}>
                <div className={styles.contacts_info}>
                    ...
                    <div className={styles.newsletter}>
                        ...
                        <label for="newsletter-si">Voglio iscrivermi!</label>
                        <input type="radio" name="newsletter" id="newsletter-no" value="no" /> 
                        <label for="newsletter-no">No, grazie.</label>
                    </div>
                </div>
                <div className={styles.contacts_form}>
                    <form>
                        ...
                        <label for="testoForm">Scrivi qui il tuo commento</label>
                        <textarea name="testoForm" id="testoForm" placeholder="Scrivi qui il tuo commento" required></textarea>
                        <div>
                            <input type='checkbox' name='privacy' required/>
                            <label for='privacy'> Autorizzo il trattamento dei miei dati personali in base all’art. 13 del D. Lgs. 196/2003
